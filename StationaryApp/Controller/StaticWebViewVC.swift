...
class StaticWebViewVC: BaseViewController {
    ...
    private func initiateWebView() {
        ...
        switch navigation {
        case .returnPolicy:
            self.titleLbl.text = "Return Policy".localized
            urlStr = ""
            break
        case .shippingPolicy:
            self.titleLbl.text = "Shipping Policy".localized
            ...
            break
        case .warrantyPolicy:
            self.titleLbl.text = "Warranty policy".localized
            ...
            break
        case .privacyPolicy:
            self.titleLbl.text = "Privacy Policy".localized
            ...
            break
        case .termsConditon:
            self.titleLbl.text = "Terms & Conditions".localized
