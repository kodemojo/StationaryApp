...
- (void)updateLabelValues {
    ...
    self.minLabel.string = [[formatter stringFromNumber:@(self.selectedMinimum)] stringByAppendingString:@" LYD"];
    self.maxLabel.string = [[formatter stringFromNumber:@(self.selectedMaximum)] stringByAppendingString:@" LYD"];
